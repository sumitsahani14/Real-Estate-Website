...
function formatPrice(n) {
  // Fictional listings use the original numeric dataset; present all public
  // prices in INR for the India-facing version of the site.
  const inr = Math.round(n * 90);
  if (inr >= 10000000) {
    const crore = inr / 10000000;
    return "₹" + (crore >= 10 ? crore.toFixed(2) : crore.toFixed(2)) + " Cr";
  }
  if (inr >= 100000) {
